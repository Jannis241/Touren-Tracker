...
fn Beispiel() {
    ...
    let neue_tour1 = Tour::new("test", 9.3, 200, vec![Person::Mama, Person::Papa], 1);
    let neue_tour2 = Tour::new("fufu", 7.0, 900, vec![Person::Jannis, Person::Mama], 5);
    let neue_tour3 = Tour::new("bre", 8.0, 1400, vec![Person::Papa, Person::Jesko], 7);
